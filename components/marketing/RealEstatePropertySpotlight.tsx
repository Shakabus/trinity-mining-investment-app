    ...
    options: [
      {
        ...
        projectedBand: '580% - 760% total cycle',
        illustrativeOutcome: '$7,500 -> $51,000-$64,500 in 12 months',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        projectedBand: '630% - 840% total cycle',
        illustrativeOutcome: '$18,000 -> $131,400-$169,200 over 18 months',
      },
      {
