...
const MINING_PLANS: MiningPlanRow[] = [
  ...
  {
    name: 'Standard Plan',
    hashrate: '10,000 TH/s',
    buyInPrice: '$10,000.00',
    payoutPrice: '$29,000.00',
    durationDays: [2],
    type: 'Mining',
  },
  {
    name: 'Pro Plan',
    hashrate: '40,000 TH/s',
    buyInPrice: '$20,000.00',
    payoutPrice: '$62,000.00',
    durationDays: [3],
    type: 'Mining',
  },
  {
    name: 'VIP Plan',
    hashrate: '200,000 TH/s',
    buyInPrice: '$50,000.00',
    payoutPrice: '$165,000.00',
    durationDays: [4],
    type: 'Mining',
  },
  {
